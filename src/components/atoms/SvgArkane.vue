<template>
    <svg class="whitelabel-poweredby__logo" viewBox="0 0 334 66">
        <defs>
            <linearGradient id="arkane-gradient" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(-8)">
                <stop offset="-.4" stop-color="#f74989">
                    <animate id="anim" attributeName="offset" from="-.4" to="1" dur="1000ms" fill="freeze"
                             begin="2s;anim.end+5000ms"/>
                    <animate id="anim2" attributeName="offset" from="-.8" to="-2" dur="220ms" fill="freeze"
                             begin="anim.end+500ms"/>
                </stop>
                <stop offset="0" stop-color="#dd49f8">
                    <animate attributeName="offset" from="0" to="1.4" dur="1000ms" fill="freeze"
                             begin="2s;anim.end+5000ms"/>
                    <animate attributeName="offset" from="-.4" to="0" dur="220ms" fill="freeze" begin="anim.end+500ms"/>
                </stop>
                <stop offset=".4" stop-color="#f74989">
                    <animate attributeName="offset" from=".4" to="1.8998" dur="1000ms" fill="freeze"
                             begin="2s;anim.end+5000ms"/>
                    <animate attributeName="offset" from="0" to=".4" dur="220ms" fill="freeze" begin="anim.end+500ms"/>
                </stop>
                <stop offset=".4001" stop-color="#f74989">
                    <animate attributeName="offset" from=".4001" to="1.8999" dur="1000ms" fill="freeze"
                             begin="2s;anim.end+5000ms"/>
                    <animate attributeName="offset" from=".0001" to=".4001" dur="220ms" fill="freeze"
                             begin="anim.end+500ms"/>
                </stop>
...
<script lang="ts">
    ...
    @Component
    export default class SvgArkane extends Vue {
    }
</script>
...
<style scoped>
    .text {
        ...
        stroke-width: 0.25px;
        font-family: HelveticaNeue-Thin, Helvetica Neue, Roboto, sans-serif;
