<template>
  <div class="container">
    <div class="dialog-container" v-if="!(showCreateWallet || showImportWallet)">
      ...
      <link-wallets-dialog v-if="showManageWallets" :wallets="wallets" :chain="chain" :thirdPartyClientId="thirdPartyClientId"
      ...
      <redirect-dialog v-if="showWalletsLinked" :class="'success'" :title="'Congratulations!'" :icon="'success'" :redirectUri="redirectUri" :timeleft="timeleft">
...
<script lang="ts">
    ...
    export default class LinkWalletsView extends Vue {
