  ...
  <div class="container">
    <div class="dialog-container">
      <import-wallet-dialog v-if="showImportWallet" :thirdPartyClientId="thirdPartyClientId"
                            @importPrivateKeyClicked="importPrivateKey" @importKeystoreClicked="importKeystore">
      </import-wallet-dialog>

      <master-pin-dialog :title="'Import a wallet'" :actionLabel="'Import Wallet'" @done="masterpinEntered" v-if="showEnterMasterPin()">
...
<script lang="ts">
    ...
    export default class ImportWalletView extends Vue {
        ...
        private showEnterMasterPin(): boolean {
